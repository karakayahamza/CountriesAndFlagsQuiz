...
import com.example.countriesandflagsquiz.databinding.FragmentGuessCapitalOfCityBinding
import com.example.countriesandflagsquiz.viewmodels.CountriesAndFlagsViewModel

class GuessCapitalOfCity : Fragment() {
    private var _binding: FragmentGuessCapitalOfCityBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGuessCapitalOfCityBinding.inflate(inflater, container, false)
